...
class CarOwners(models.Model):
    carNumber = models.ForeignKey('Car', on_delete=models.CASCADE, primary_key=True)
    carOwner = models.ForeignKey('CustomUser', on_delete=models.CASCADE, primary_key=True)
